 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    <thead>
        <tr>
            ...
            <th width="10%"><a  <?php echo $is_external_sort; ?> href="canned.php?<?php echo $qstr; ?>&sort=is_external"><?php echo __('Is external?');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        ...
        if($res && db_num_rows($res)):
            ...
            <tr id="<?php echo $row['canned_id']; ?>">
                ...
                <td><?php echo $row['is_external']?__('Internal'):'<b>'.__('External').'</b>'; ?></td>
            </tr>
            <?php
            } //end of while.
        endif; ?>
